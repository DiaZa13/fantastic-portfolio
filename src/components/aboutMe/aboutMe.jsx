    ...
    <div className="container-fluid about-container align-items-center">
      ...
      <h3 className="text-tertiary px-5 justify-text">
        ...
        <div className="d-flex justify-content-between text-tertiary">
          <a href="#" className="is-hover"><MdEmail /></a>
          <a href="#" className="is-hover"><AiFillGithub /></a>
          <a href="#" className="is-hover"><AiOutlineInstagram /></a>
          <a href="#" className="is-hover"><AiOutlineWhatsApp /></a>
        </div>
      </h3>
