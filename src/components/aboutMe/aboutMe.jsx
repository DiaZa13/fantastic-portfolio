  ...
  return (
    <div className="container-fluid about-container align-items-center">
      ...
      <h3 className="text-tertiary px-5 justify-text">
        Soy estudiante de la Ingeniería en Ciencias de la Computación  Tecnologías de la
        Información en la Universidad del Valle Guatemala, actualmente tengo 19 años
        (SOY ADULTO INDEPENDIENTE, CON GUSTOS BIEN DEMENTES)
        Soy una persona apasionada, entusiasta y creativa. Perfeccionista en el
        ámbito del diseño y amante de las
